...
public class GodSelectionScreen extends Screen {
    ...
    private final String godName; // Name of the selected god

    public GodSelectionScreen(Text title, String godName) {
        super(title);
        this.godName = godName; // Store the name of the selected god
    }
    ...
    protected void init() {
        ...
        this.addDrawableChild(ButtonWidget.builder(Text.of("Return"), btn -> {
            if (this.client != null) {
                this.client.setScreen(new GodsScreen(Text.of("Gods"))); // Return to the Gods screen
            }
    ...
    public void render(DrawContext contents, int mouseX, int mouseY, float delta) {
        ...
        String text = godName; // Title text
        ...
        // Draw the box for god details (placeholder background)
